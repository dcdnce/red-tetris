...
/* --- Route Catch All --- */
appExpress.get(/^\/(?!api|socket.io).*/, (req, res)=> { // Regex pour capturer tout sauf /api et /socket.io
...
httpServer.listen(PORT, () => {
    ...
    console.log(`--- Access the app in production (after build) at http://localhost:${PORT} ---`);
});